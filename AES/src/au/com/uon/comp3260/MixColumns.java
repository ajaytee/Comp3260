...
public class MixColumns {
	...
	public String mix(String inputString, String option) {
		...
		// Steps: 1. Each cell in column 1 is multiplied by 2,3,1,1
		// respectively, sum is value of cell [0][0]
		// 2. Each cell in column 1 is multiplied by 1,2,3,1 respectively, sum
		// is value of cell [1][0]
		// 3. Each cell in column 1 is multiplied by 1,1,2,3 respectively, sum
		// is value of cell [2][0]
		// 4. Each cell in column 1 is multiplied by 3,1,1,2 respectively, sum
		// is value of cell [3][0]

		for (int i = 0; i < 4; i++) { // i = rows
			for (int j = 0; j < 4; j++) { // j = columns

				// hexMatrix[j][i] = sum of: hexMatrix[0][i] *
				// mixColumnsMatrix[j][0];
